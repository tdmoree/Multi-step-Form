...
function goStepFour() {
    ...
    circle3.style.color = "white";
    circle3.style.backgroundColor = "rgba(255, 255, 255, 0)";
    circle4.style.backgroundColor = "rgba(255, 255, 255)";
...
checkBox = document
    ...
    checkBox = document
        ...
        .addEventLIstener("click", event => {
            ...
            moisAvanced.style.backgroundColor = "white";
            moisAvanced.style.border = "solid 1px hsl(229, 24%, 87%)";
            ...
            document.getElementById("priceResume").innerHTML = "95/mo";
    ...
    checkBox = document
        ...
        .addEventLIstener("click", event => {
            ...
            document.getElementById("priceResume").innerHTML = "125/mo";
            document.getElementById("modeTotal").innerHTML = "Total (per month)";
        });
    checkBox = document
        ...
        .addEventLIstener("click", event => {
            ...
            document.getElementById("priceResume").innerHTML = "155/mo";
            document.getElementById("modeTotal").innerHTML = "Total (per month)";
        });
    checkBox = document
        ...
        .addEventLIstener("click", event => {
            ...
            document.getElementById("priceResume").innerHTML = "905/yr";
    ...
    checkBox = document
        ...
        .addEventLIstener("click", event => {
            ...
            document.getElementById("priceResume").innerHTML = "120$/yr";
            document.getElementById("modeTotal").innerHTML = "Total (per year)";
        });
    checkBox = document
    ...
    function checkMail() {
        ...
        let myMailRegex = /^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:\.[a-zA-Z0-9-]+)*$/;
